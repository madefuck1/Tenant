...
import com.ak.platform.service.system.ISysConfigService;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    //添加用户信息
    @Override
    public SysUser insertUserDefault(SysTenant tenant, SysDept dept) {
        SysUser user = new SysUser();
        user.setDeptId(dept.getDeptId());
        user.setLoginName(tenant.getTenantCode() + "_admin");
        user.setUserName(tenant.getTenantCode() + "_admin");
        ...
        user.setPassword(new Md5Hash(tenant.getTenantCode() + "_admin" + user.getPassword() + user.getSalt()).toHex().toString());
