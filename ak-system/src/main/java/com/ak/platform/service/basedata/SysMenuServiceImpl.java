...
import com.ak.platform.mapper.basedata.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<SysMenu> selectMenusByUser(SysUser user) {
        ...
        if (user.isAdmin()) {
            ...
            menus = menuMapper.selectMenusByUser(user);
        }
    ...
    public List<SysMenu> selectMenuList(SysMenu menu, SysUser user) {
        ...
        if (SysUser.isAdmin(user.getUserId())) {
            ...
            menu.getParams().put("tenantCode", user.getTenantCode());
    ...
    public List<Ztree> initZtree(List<SysMenu> menuList, List<String> roleMenuList, boolean permsFlag) {
        ...
        for (SysMenu menu : menuList) {
            ...
            params.put("appCode", menu.getAppCode());
            ztree.setParams(params);
