...
import com.ak.platform.domain.basedata.SysRoleDept;
import com.ak.platform.domain.basedata.SysRoleMenu;
import com.ak.platform.domain.basedata.SysUserRole;
import com.ak.platform.domain.system.SysTenant;
import com.ak.platform.mapper.basedata.SysRoleDeptMapper;
import com.ak.platform.mapper.basedata.SysRoleMapper;
import com.ak.platform.mapper.basedata.SysRoleMenuMapper;
import com.ak.platform.mapper.basedata.SysUserRoleMapper;
...
public class SysRoleServiceImpl implements ISysRoleService {
     ...
     */
    @Override
    public SysRole insertSysRoleDefault(SysTenant tenant) {
        ShiroUtils.clearCachedAuthorizationInfo();
        SysRole role = new SysRole();
        role.setRoleName(tenant.getTenantName() + "_管理员");
        role.setRoleKey(tenant.getTenantCode() + "_admin");
        role.setRoleSort("1");
        role.setDataScope("1");
        role.setStatus("0");
