...
import com.ak.platform.mapper.basedata.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService {
    ...
    public int insertDept(SysDept dept) {
        if (null != dept.getParentId() && !dept.getParentId().equals(0L)) {
    ...
    @Override
    public SysDept insertSysDeptDefault(SysTenant tenant) {
        SysDept dept = new SysDept();
        //父级部门
    ...
    public SysDept selectDeptByParentId(Long parentId) {
        return deptMapper.selectDeptByParentId(parentId, ShiroUtils.getSysUser().getTenantCode());
    }
}
