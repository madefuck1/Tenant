...
public class SysRoleController extends BaseController {
    private String prefix = "basedata/role";
    ...
    @RequiresPermissions("basedata:role:view")
    @GetMapping()
    public String role() {
        return prefix + "/role";
    }

    @RequiresPermissions("basedata:role:list")
    @PostMapping("/list")
    @ResponseBody
    ...
    @RequiresPermissions("basedata:role:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存角色
     */
    @RequiresPermissions("basedata:role:add")
     ...
     * 修改保存角色
     */
    @RequiresPermissions("basedata:role:edit")
    ...
    @RequiresPermissions("basedata:role:remove")
