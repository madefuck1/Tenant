package com.ak.platform.controller.message;
...
import com.ak.platform.service.message.ISysNoticeService;
...
public class SysNoticeController extends BaseController {
    private String prefix = "message/notice";

    @Autowired
    private ISysNoticeService noticeService;

    @RequiresPermissions("message:notice:view")
    @GetMapping()
     ...
     * 查询公告列表
     */
    @RequiresPermissions("message:notice:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 新增保存公告
     */
    @RequiresPermissions("message:notice:add")
     ...
     * 修改保存公告
     */
    @RequiresPermissions("message:notice:edit")
    @Log(title = "编辑通知公告", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
     ...
     * 删除公告
     */
    @RequiresPermissions("message:notice:remove")
