...
import com.ak.platform.service.basedata.ISysMenuService;
 ...
 */
@Controller
@RequestMapping("/basedata/menu")
public class SysMenuController extends BaseController {
    private String prefix = "basedata/menu";
    ...
    @RequiresPermissions("basedata:menu:view")
    @GetMapping()
    public String menu() {
        return prefix + "/menu";
    }

    @RequiresPermissions("basedata:menu:list")
    @PostMapping("/list")
    @ResponseBody
    ...
    @RequiresPermissions("basedata:menu:remove")
    ...
    public String add(@PathVariable("parentId") Long parentId, ModelMap mmap) {
        ...
        //获取所有系统
        List<SysApplication> applications = applicationService.getSysApplications();
        mmap.put("menu", menu);
    ...
    @RequiresPermissions("basedata:menu:add")
    @PostMapping("/add")
    @ResponseBody
    ...
    @RequiresPermissions("basedata:menu:edit")
    @PostMapping("/edit")
    @ResponseBody
