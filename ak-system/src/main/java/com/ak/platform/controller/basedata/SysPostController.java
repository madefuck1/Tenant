...
import com.ak.platform.domain.basedata.SysPost;
import com.ak.platform.service.basedata.ISysPostService;
...
public class SysPostController extends BaseController {
    private String prefix = "basedata/post";

    @Autowired
    private ISysPostService postService;

    @RequiresPermissions("basedata:post:view")
    @GetMapping()
    public String operlog() {
        return prefix + "/post";
    }

    @RequiresPermissions("basedata:post:list")
    @PostMapping("/list")
    @ResponseBody
    ...
    @RequiresPermissions("basedata:post:export")
    @PostMapping("/export")
    @ResponseBody
    ...
    @RequiresPermissions("basedata:post:remove")
     ...
     * 新增保存岗位
     */
    @RequiresPermissions("basedata:post:add")
     ...
     * 修改保存岗位
     */
    @RequiresPermissions("basedata:post:edit")
