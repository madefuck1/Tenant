...
public class SysUserController extends BaseController {
    private String prefix = "basedata/user";
    ...
    @RequiresPermissions("basedata:user:view")
    @GetMapping()
    public String user() {
        return prefix + "/user";
    }

    @RequiresPermissions("basedata:user:list")
    @PostMapping("/list")
    @ResponseBody
    ...
    @RequiresPermissions("basedata:user:export")
    @PostMapping("/export")
    @ResponseBody
    ...
    @RequiresPermissions("basedata:user:import")
     ...
     * 新增保存用户
     */
    @RequiresPermissions("basedata:user:add")
     ...
     * 修改保存用户
     */
    @RequiresPermissions("basedata:user:edit")
    ...
    @RequiresPermissions("basedata:user:resetPwd")
    ...
    @RequiresPermissions("basedata:user:remove")
